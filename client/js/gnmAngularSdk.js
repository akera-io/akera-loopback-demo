  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Customer#describe
         * @methodOf lbServices.Customer
         *
         * @description
         *
         ...
         */
        "describe": {
          url: urlBase + "/Customers/describe",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Customer#getBalance
         * @methodOf lbServices.Customer
         *
         * @description
         *
         * Get a customer balance information
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{number}` - 
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Order#describe
         * @methodOf lbServices.Order
         *
         * @description
         *
